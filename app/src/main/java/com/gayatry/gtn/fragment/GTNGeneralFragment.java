 ...
 */
public class GTNGeneralFragment extends Fragment implements View.OnClickListener{
    ...
    private void initView(View view) {
        ...
        mRadioGrpGrnType = (RadioGroup) view.findViewById(R.id.radioGroupGtnType);
    ...
    void getGeneratedGtnCode(String grnType){
        if(AppUtils.isOnline(getActivity())) {
            ...
            asyncTaskCommon.execute(getString(R.string.get_grn_code_url) + "/" + ((AddGTNActivity) getActivity()).mProjectId + "/gtn/" +
    ...
    public String getAllValues() {
        ...
        try {
            ...
            jsonObject.put("TotalGTNValue", ""+((AddGTNActivity)getActivity()).mAssesableAmount);
